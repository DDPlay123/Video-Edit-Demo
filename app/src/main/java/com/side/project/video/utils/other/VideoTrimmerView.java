package com.side.project.video.utils.other;

import static com.side.project.video.utils.other.util.VideoTrimmerUtil.MAX_COUNT_RANGE;
import static com.side.project.video.utils.other.util.VideoTrimmerUtil.MAX_SHOOT_DURATION;
import static com.side.project.video.utils.other.util.VideoTrimmerUtil.RECYCLER_VIEW_PADDING;
import static com.side.project.video.utils.other.util.VideoTrimmerUtil.THUMB_WIDTH;
import static com.side.project.video.utils.other.util.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
import com.side.project.video.utils.other.util.BackgroundExecutor;
import com.side.project.video.utils.other.util.IVideoTrimmerView;
import com.side.project.video.utils.other.util.SingleCallback;
import com.side.project.video.utils.other.util.StorageUtil;
import com.side.project.video.utils.other.util.UiThreadExecutor;
import com.side.project.video.utils.other.util.VideoTrimListener;
import com.side.project.video.utils.other.util.VideoTrimmerAdapter;
import com.side.project.video.utils.other.util.VideoTrimmerUtil;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
    ...
    public void initVideoByURI(final Uri videoURI) {
        ...
        mVideoShootTipTv.setText(String.format("拖动选择你要发表的%d秒以内片段！", VideoTrimmerUtil.VIDEO_MAX_TIME));
    }
    ...
    private void setPlayPauseViewIcon(boolean isPlaying) {
        mPlayView.setImageResource(isPlaying ? R.drawable.img_video_pause_black : R.drawable.img_video_play_black);
    }
